  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-dark-50 via-white to-primary-50"></div>
        <div className="absolute inset-0 opacity-40">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-200/40 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent-200/40 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 text-center">
        <div className="animate-slide-down">
          <div className="inline-flex items-center gap-2 px-4 py-2 glass-effect rounded-full mb-8">
            ...
            <span className="text-sm text-dark-600 font-medium">Deploy AI in 30-60 Days</span>
          </div>
        </div>
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 animate-slide-up font-display">
          ...
          <br />
          <span className="text-dark-900">With Lightning-Fast AI</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <a
            href="#results"
            className="px-8 py-4 bg-white/80 border border-dark-200 text-dark-700 rounded-lg font-semibold text-lg hover:bg-white hover:shadow-md transition-all inline-flex items-center justify-center"
          >
            See Results
          </a>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          {[
            ...
            <div key={index} className="bg-white/80 backdrop-blur-sm border border-dark-200/60 rounded-xl p-6 shadow-sm">
