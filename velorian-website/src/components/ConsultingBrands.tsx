      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {consultingBrands.map((brand, index) => (
            <div
              key={brand.domain}
              className="bg-white rounded-2xl p-8 border border-dark-200 shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300 group relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-dark-900 mb-2 font-display">
                  {brand.name}
                </h3>
                <a
                  ...
                  className={`inline-flex items-center gap-2 mb-4 ${
                    brand.color === 'primary' ? 'text-primary-500' : 'text-accent-500'
                  } hover:underline`}
                >
                  {brand.domain}
                  <ExternalLink className="w-4 h-4" />
                </a>
                <p className="text-lg font-semibold text-dark-700 mb-4">
                  {brand.tagline}
                </p>
        ...
        <div className="mt-16 text-center bg-white rounded-2xl p-8 border border-dark-200 shadow-sm">
